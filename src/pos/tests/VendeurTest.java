...
public class VendeurTest {
	...
	public void testGetPassword() {
		assertTrue(v1.getPassword().equals(commun.utils.SHAUtil.hashPassword("Test1234")));
		assertTrue(v2.getPassword().equals(commun.utils.SHAUtil.hashPassword("Soccer12")));
	}
